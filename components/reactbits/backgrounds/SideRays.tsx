...
const SideRays = ({
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      containerRef.current.appendChild(gl.canvas as HTMLElement);
      ...
      cleanupFunctionRef.current = () => {
        ...
        if (renderer) {
          try {
            ...
            if (canvas && (canvas as HTMLElement).parentNode) {
              (canvas as HTMLElement).parentNode!.removeChild(canvas as HTMLElement);
            }
          } catch {}
        }
