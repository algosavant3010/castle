...
interface CreateWalletInlineProps {
  onClose: () => void;
}

export function CreateWalletInline({ onClose }: CreateWalletInlineProps) {
  ...
  }, [wallets, step, isSuccess, initialWalletCount, walletName, saveName]);
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                <p className="text-[11px] text-faint mt-1.5">
                  A label to identify this wallet. Stored locally on your device.
                </p>
              </div>
